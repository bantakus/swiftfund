...
function Calculator() {
    ...
    const faqs = [
        {question:" What are the eligibility criteria for obtaining a loan?", answer:"To be eligible for a loan with us, you must meet certain criteria including being of legal age (18 years or older), having a steady source of income, and possessing at least good to fair credit history. Additionally, we may require proof of identity, residency, and other documentation as part of our application process.",open:false},
        {question:"How much can I borrow from your company?", answer:" The loan amount you can borrow depends on various factors including your income, credit history, and the specific loan product you're interested in. We offer a range of loan options to accommodate different financial needs, and the maximum amount you can borrow will be determined during the application process.",open:false},
...
<div className='w-full'>
 <Horizontal_nav activated={"calculator"} />
 {/* main */}
