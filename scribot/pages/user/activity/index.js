...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0  " aria-label="Sidebar">
   ...
   <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="/user/loan" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
         ...
         <li>
            <Link href="/user/activity" className="flex items-center p-2  p-2 text-white rounded-lg  hover:bg-gray-700 bg-sky-500 group">
...
<div className="p-4 sm:ml-64 lg:w-[75%] lg:items-center lg:flex lg:justify-center  ">
   ...
   <div className='text-slate-600 py-5 font-semibold text-2xl'>
    Activities
      ...
      <div className='flex flex-col items-center justify-center rounded rounded-xl bg-gray-100 p-5  text-slate-600 gap-5 font-normal lg:w-full'>
       <div>
