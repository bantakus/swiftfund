...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0  " aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <Link href="/user/account" className="flex items-center p-2  p-2 text-white rounded-lg  hover:bg-gray-700 bg-sky-500 group">
...
<div className="p-4 sm:ml-64 lg:w-[75%] lg:items-center lg:flex lg:justify-center cursor-pointer ">
   <div className="p-4  rounded-lg  mt-14 ">
      <div className="gap-4 mb-4  ">
        {/* First Part */}
         <div className="flex items-center justify-start h-24 rounded rounded-xl bg-gray-200 p-5 text-slate-100 lg:w-full">
            <div className='flex gap-5 text-center items-center'>
                <div className='flex gap-2  font-semibold items-center justify-start'>
                    <Image src={"/static/auth.jpg"} alt="user" height={1000} width={1000}  className='rounded rounded-full w-12 h-12 lg:h-20 lg:w-20'/>
                </div>
      ...
      <div className='flex flex-col items-start justify-start rounded rounded-xl bg-gray-200 p-5  text-slate-600 gap-5 font-semibold lg:w-full'>
        {/*  */}
      ...
      <div className='flex flex-col items-start justify-start rounded rounded-xl bg-gray-200 p-5  text-slate-600 gap-5 font-semibold mt-5 lg:w-full'>
        ...
        <div className='flex justify-between py-1 w-full '>
        <div>
            <span className='bg-sky-500 text-white p-3 rounded rounded-lg cursor-pointer'>Link Facebook</span>
        </div>
