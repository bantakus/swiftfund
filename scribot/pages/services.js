...
function Services() {
    ...
    const faqs = [
      ...
      const services =[
        {
            loanType:"Personal Loan",title:"Strategic Connections",content:"Get a payday loan for 30 to 90 daysA 3-month Phoenix Financing & Business Consultancy payday loan is a fantastic option to consider when you need cash. Apply for this loan at the best rates with smooth processing systems.",img:"personal"
        },
        {
            loanType:"Business Loan",title:"Grow Business with easy application",content:"Recognizing the unique needs of each client, our team crafts personalized and flexible financing solutions, ensuring that your financial strategy aligns seamlessly with your business goals.",img:"business"
        },
        {
            loanType:"Wedding Loan",title:"From Honeymoons to Wedding Loans",content:"Celebrate your love story in style with Phoenix Financing & Business Consultancy's Wedding Loans and Destination Wedding Loans. We understand that your wedding day is one of the most important milestones in your life, and we're here to help you turn your dreams into reality. ",img:"wedding"
        },
        {
            loanType:"Honey Moon Safari Loan",title:"Tell your Story in a different Reality",content:"Escape to paradise and embark on the honeymoon of your dreams with us. Whether you envision lounging on pristine beaches, exploring exotic landscapes, or indulging in luxury accommodations, our destination honeymoon loans make it all possible. ",img:"honeymoon"
        },
        {
            loanType:"Holiday Safari Loan ",title:"Explore the Savannah",content:"Bring the Whole Family to the Great Savannah with the Family Safari with Phoenix Financing holiday loan Bring grandma and grandpa along on this luxury.",img:"holiday"
        },
        {
            loanType:"Auto Loan",title:"Drive at a click of a button",content:"Our auto loans offer competitive rates and flexible terms, making it simple to drive off the lot in style. Whether you're eyeing a sleek sedan, a rugged SUV, or a fuel-efficient h",img:"car"
        },
        {
            loanType:"Equipment Loan",title:"Unlock Your Business Potential with Equipment Loans",content:"Upgrade Your Business with Equipment Loans. From machinery to technology, our financing solutions help you acquire the tools you need to succeed. Enjoy competitive rates and flexible terms tailored to your business needs. Streamline operations and boost productivity with ease.",img:"equipments"
        },
        {
            loanType:"Agricultural Loan",title:"Advance into Greater Production",content:"Grow Your Farming Dreams with Our Agricultural Loans. From equipment upgrades to expansion projects, we're here to support your agricultural endeavors with flexible financing solutions tailored to your needs. Take the next step toward a thriving farm operation with our dedicated support and competitive rates",img:"agric"
        },
...
<div className='w-full'>
 <Horizontal_nav activated={"services"} />
 {/* main */}
 <main className='relative overflow-hidden   text-white'>
 <ScrollToTop smooth />
 {/* Lists of all the Services */}
   <div className='bg-slate-100 min-h-screen text-slate-800 py-16 px-16 lg:px-26'>
    <div className='text-4xl font-semibold text-center p-12'><span className='text-green-500 '>Services</span> We Offer</div>
...
<div class="px-6 py-4">
{/* Title */}
<div class="font-bold text-xl mb-2 text-green-900 ">{ele.title}</div>
{/* Content */}
<p class="text-gray-700 text-base">
  {ele.content}
</p>
</div>
<div class="py-6 flex w-full justify-center items-center gap-5 ">
...
a 5% Discount on Your First Loan</div> 
 <div className='text-slate-300 text-sm lg:text-md'>You can also get up to 10% from referrals </div>
    ...
    Take a Loan <span><FaArrowRight /></span>
     ...
     {/* Third section */}
   <div className='min-h-screen bg-white flex flex-col lg:flex-row items-center justify-center px-auto px-16 gap-12 py-16 '>
     {/* content text */}
