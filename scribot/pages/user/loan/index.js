...
import { BsCardList, BsCurrencyBitcoin, BsHeadset, BsKey, BsNewspaper, BsPaperclip, BsPerson, BsSave, BsSend, BsWallet, BsWallet2, BsWalletFill } from 'react-icons/bs';
...
<div className="p-4 sm:ml-64 lg:w-[75%] lg:items-center lg:flex lg:justify-center  ">
   ...
   <div className='text-slate-600 py-5 font-semibold text-2xl'>
    Loan
      ...
      <div className="gap-4 mb-4  ">
        {/* First Part */}
         <div className=" border border-dashed border-slate-500 flex items-start justify-start h-24 rounded rounded-xl bg-sky-100 p-5 text-slate-100 lg:w-full">
 ...
 <div className='rounded rounded-xl cursor-pointer text-sm bg-slate-100 text-slate-700 p-1 px-3'>
                    No Loan activity
                </div>
                </div>
               <div className='bg-green-500 text-white p-3 px-5 rounded rounded-xl cursor-pointer'>
                Apply for a Loan
               </div>
            </div>
      ...
      <div className='flex flex-col items-start justify-start rounded rounded-xl bg-gray-100 p-5  text-slate-600 gap-5 font-semibold lg:w-full'>
        {/*  */}
      ...
      {/* kyc */}
      <div className='flex flex-col items-start justify-start rounded rounded-xl bg-gray-200 p-5  text-slate-600 gap-5 font-semibold mt-5 lg:w-full'>
        {/* intro */}

        <div className='flex flex-col gap-2 items-start'>
        <div className='text-xl '>
            Loan amount increase tasks
        </div>
        <div className='text-slate-400 font-normal '>
            Complete tasks to get amount increase up to <span className='text-orange-500'>$100,000</span>
        </div>
        </div>
        {/*  */}
        <div className='flex justify-between py-1 w-full cursor-pointer'>
        <div>
            Bind Card
        </div>
        <div className='text-green-600 font-normal cursor-pointer'>
            Increase {">"}
        </div>
        </div>
        {/*  */}
        <div className='flex justify-between w-full py-1 cursor-pointer'>
        <div>
           Take Selfie
        </div>
        <div className='text-green-600 font-normal cursor-pointer'>
